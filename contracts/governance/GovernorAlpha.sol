...
contract GovernorAlpha {
    ...
    string public constant name = "Arcanum Governor Alpha";
    ...
    /// @notice The address of the Arcanum Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Arcanum governance token
    ArcInterface public arc;
    ...
    function propose(
        ...
        require(
            arc.getPriorVotes(msg.sender, sub256(block.number, 1)) >
                proposalThreshold,
    ...
    function cancel(uint256 proposalId) public {
        ...
        Proposal storage proposal = proposals[proposalId];
        require(
            arc.getPriorVotes(proposal.proposer, sub256(block.number, 1)) <
                proposalThreshold,
    ...
    function _castVote(
        ...
        uint96 votes = arc.getPriorVotes(voter, proposal.startBlock);

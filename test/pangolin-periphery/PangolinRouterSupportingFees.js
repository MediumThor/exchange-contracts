...
describe('ArcanumRouterSupportingFees', function () {
    const BIPS = 10_000;

    let OWNER, user1, user2, user3;
    let ArcanumRouterSupportingFees, ArcanumFactory, ArcanumPair, _Token, _Wavax;
    let router, arcanumFactory;
    let wavax, tokenA, tokenB;

    before(async function () {
        [OWNER, user1, user2, user3] = await ethers.getSigners();

        ArcanumRouterSupportingFees = await ethers.getContractFactory('ArcanumRouterSupportingFees');
    ...
    beforeEach(async function () {
        ...
        router = await ArcanumRouterSupportingFees.deploy(
    ...
    describe('Swapping', async function () {
        ...
        function testSwapMethods() {
            describe('swapExactTokensForTokens', async function () {
                ...
                beforeEach(async function () {
                    pair = await createPair(tokenA, tokenB, arcanumFactory);
            ...
            describe('swapExactAVAXForTokens', async function () {
                ...
                beforeEach(async function () {
                    pair = await createPair(wavax, tokenB, arcanumFactory);
            ...
            describe('swapTokensForExactAVAX', async function () {
                ...
                beforeEach(async function () {
                    pair = await createPair(tokenA, wavax, arcanumFactory);
    ...
    // Helpers
    async function createPair(tokenA, tokenB, factory = arcanumFactory) {

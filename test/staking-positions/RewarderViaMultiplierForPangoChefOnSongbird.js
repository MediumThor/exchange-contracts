...
console.log("Before running this test, set `onReward()` hook boolean (destructiveAuction) to `true` in `harvestWithoutReset()` function of ArcanaChef. That parameters was wrongly set in Songbird. Make that change such that this actually tests the behaviour of Arcanachef as deployed on Songbird.");

// Start test block
describe("RewarderViaMultiplierForArcanaChefOnSongbird.sol", function () {
  before(async function () {
    ...
    this.Rewarder = await ethers.getContractFactory("RewarderViaMultiplierForArcanaChefOnSongbird");
  });
  ...
  beforeEach(async function () {
    ...
    this.amount = this.arl_amount.div("10");
